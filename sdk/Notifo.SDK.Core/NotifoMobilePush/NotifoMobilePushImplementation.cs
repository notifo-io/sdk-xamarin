...
namespace Notifo.SDK.NotifoMobilePush
{
    internal partial class NotifoMobilePushImplementation : INotifoMobilePush
    {
        ...
        {
            ClearStore(commandStore);
            ClearStore(credentialsStore);
            ClearStore(seenNotificationsStore);
            return this;
        }
        ...
        {
            ConfigureStore(commandStore, sharedName);
            ConfigureStore(credentialsStore, sharedName);
            ConfigureStore(seenNotificationsStore, sharedName);
            return this;
        }

        private static void ConfigureStore(object store, string sharedName)
        {
